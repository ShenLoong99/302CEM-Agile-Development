    ...
    <main class="mb-5">
                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="hero-cap text-center">
                                <h2>Events that you registered</h2>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <a onMouseOver="this.style.filter='brightness(1.3)'" onMouseOut="this.style.filter='brightness(1)'" style="display: inline-block; text-decoration: none; color: inherit; outline: 0;" href="/event_details/1">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text mb-1">{{ $row['quantity'] }} Tickets</p>
        ...
        @if (empty(Auth::user()->id))
            <div class="container mt-5">
                <h3 class="text-center">You are not logged in. Please log in to check your registered event list...</h3><br>
                <center><a class="btn" href={{ '/login' }}>Log In</a></center>
            </div>
        @else 
            @if ($count == 0)
                <div class="container mt-5">
                    <h3 class="text-center">You didn't purchase any tickets of any events yet... :(</h3>
                </div>
            @endif
        @endif
    </main>
