...
<main>
    ...
    <div class ="row">
        <div class="col-md-12">
            <br/>
            <h3 align="center">Event Listing</h3>
            <br/>
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td>{{substr($row['date_time_end'], 0, 16)}}</td>
                    <td>{{$row['ev_location']}}</td>
                    <td>{{$row['description']}}</td>
                    <td>{{$row['price']}}</td>
                    <td>{{$row['max_participants']}}</td>
                    <td>{{substr(str_replace("T", " ", $row['created_at']), 0, 16)}}</td>
                    <td>{{substr(str_replace("T", " ", $row['updated_at']), 0, 16)}}</td>
                </tr>
                @endforeach
            </table>
        </div>
