...
<body>
    ...
    <main>
        ...
        <!-- Hero End -->
        <div class="m-5 p-5">
            <form name="insert_form" action="/insert_event_image?id=<?php echo e($id); ?>" method="post">
                <?php echo csrf_field(); ?> 
                ...
                <?php else: ?> 
                    <button name="submit" type="submit" class="btn mt-50" disabled>Insert New Images!</button>
                <?php endif; ?>
            </form>
        </div>
    </main>
...
<?php echo $__env->make('layouts.head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Asus\Desktop\INTI\Y3S7\Agile Dev\302CEM-Agile-Development\resources\views/insert_event_image.blade.php ENDPATH**/ ?>