                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-8 col-md-9 col-sm-10">
                                <div class="hero__caption">
                                    ...
                                    <h2 data-animation="fadeInLeft" class="text-white" data-delay=".5s"><?php echo e($highlight->ev_name); ?></h2>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-10">
                                    <div class="single-caption mb-20">
                                        ...
                                        <div class="caption">
                                            <h5>Where</h5>
                                            <p><?php echo e($event->ev_location); ?></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-10">
                                    <div class="single-caption mb-20">
                                        ...
                                        <div class="caption">
                                            <h5>When</h5>
                                            <p><?php echo e($event->date_time_start); ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6 col-md-12">
                            ...
                            <div class="about-img ">
                                <div class="about-back-img ">
                                    <img style="width: 500px; height: 350px" src=<?php echo e($event->image); ?> alt="event photo">
                                </div>
                            </div>
                        </div>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <center><a href="#" class="btn">View More Events</a></center>
            </div>
        </section>
        <!-- About Law End-->
        <!--? Brand Area Start-->
...
<?php echo $__env->make('layouts/head', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Asus\Desktop\INTI\Y3S7\Agile Dev\302CEM-Agile-Development\resources\views/home.blade.php ENDPATH**/ ?>