...
class EventController extends Controller
{
    ...
    public function home() {
		...
		//$update = Event::where('updated_at', '>', 'created_at')->where('active', 1)->orderBy('updated_at')->get();
		$all_ev_id = array();
		$mem_ID = Auth::id();
        ...
        return view('home', ['event' => $event, 'highlight' => $highlight, 'notifications' => $reg, 'image' => $image]);
    }
